        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="discapacidad" type="text" class="form-control" id="discapacidad" placeholder="Discapacidad">@error('discapacidad') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
